...
class BlogController extends SimpleController
{
    ...
    public function getSingleBlogAdmin(Request $request, Response $response, $args)
    {
        $blog = Blog::where('slug', $args['blog_slug'])->first();
    ...
    public function genBlog(Request $request, Response $response, $args)
    {
    ...
    public function genSingleBlogPost(Request $request, Response $response, $args)
    {
        //TODO: Returning a link that has a post title and not id
        $blog_slug = $args['blog_slug'];
